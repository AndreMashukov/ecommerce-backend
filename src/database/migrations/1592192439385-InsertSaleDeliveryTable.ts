...
export class InsertSaleDeliveryTable1592192439385
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    (2, 'Почта России', 's1', 8, 19, 'D', 0, 0, 0.00, 2999.99, 'RUB', 'Y', 400.00, 'RUB', 200, 'Доставка возможна ТОЛЬКО после 100% предоплаты.', '{"values": ["30"]}'),
    (3, 'Бесплатная доставка курьером', 's1', 1, 2, 'D', 0, 0, 1000.00, 1000000.00, 'RUB', 'Y', 0.00, 'RUB', 300, 'Без выходных в удобное для Вас время', '{"values": ["10", "20"]}'),
    (4, 'Почта России (Бесплатно!)', 's1', 8, 19, 'D', 0, 0, 3000.00, 1000000.00, 'RUB', 'Y', 0.00, 'RUB', 400, 'Доставка возможна ТОЛЬКО после 100% предоплаты.', '{"values": ["30"]}');
    `);
  }
