...
export class InsertSaleDeliveryTable1592192439385
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    (2, 'Почта России', 's1', 11, 27, 'D', 0, 0, 0.00, 999.99, 'RUB', 'Y', 200.00, 'RUB', 200, 'Доставка возможна ТОЛЬКО после 100% предоплаты.', '{"values": ["30"]}'),
    ...
    (4, 'Почта России (Бесплатно!)', 's1', 11, 27, 'D', 0, 0, 1000.00, 0.00, 'RUB', 'Y', 0.00, 'RUB', 400, 'Доставка возможна ТОЛЬКО после 100% предоплаты.', '{"values": ["30"]}');
    `);
  }
